...
static void inv_init_adv_fusion_obj( struct inv_advfusion_data *iobj_adv_fusion )
{
    ...
    iobj_adv_fusion->compass_correction_relative[0] = 1073741824L;
    iobj_adv_fusion->compass_disturb_correction[0] = 1073741824L;
    iobj_adv_fusion->compass_correction_offset[0] = 1073741824L;
    iobj_adv_fusion->relative_quat[0] = 1073741824L;
    iobj_adv_fusion->compass_state = SF_UNCALIBRATED;
    iobj_adv_fusion->compass_bias_ptr[0] = P_INIT;
    iobj_adv_fusion->compass_bias_ptr[4] = P_INIT;
    iobj_adv_fusion->compass_bias_ptr[8] = P_INIT;
    iobj_adv_fusion->gyro_bias_err = 1310720;

    for (ii = 0; ii < 3; ii++) {
        inv_obj.adv_fusion->compass_scale[ii] = 65536L;
        inv_obj.adv_fusion->compass_test_scale[ii] = 65536L;
