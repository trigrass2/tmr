...
/******************************************************************************
 *
 * $Id: mldl.c 5773 2011-07-14 22:28:32Z nroyer $
 *
 *****************************************************************************/
...
/**
 * @brief   inv_get_dl_cfg_int configures the interrupt function on the
                               ...
                               const unsigned char *buffer)
{
    ...
    if (p_get_dmp_address == NULL) {
        MPL_LOGE("MLDSetMemoryMPU p_get_dmp_address is NULL\n");
